              ...
              <Box pos="relative" w="100%">
                <ImageSlider
                  featuredMedia={{
                    image: {
                      name: 'page.slug' || 'none',
                      defaultValue: 'https://variety.com/wp-content/uploads/2021/07/Rick-Astley-Never-Gonna-Give-You-Up.png' || '',
...
const ImageSlider = (props: {featuredMedia: JaenProduct['featuredMedia']; media: JaenProduct['media']}) => {
