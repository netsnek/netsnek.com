...
export const messagesEn: MessageCatalog = {
  ...
  OpenKnowledgeText: "Our documentation publishes what we have learned, from the quantum computing chapters out of PhotonQ to the Linux and RPM notes and the security write-ups. Our RPM repository provides the patched packages that came out of that work.",
  OpenCommunityTitle: "Local Community",
  OpenCommunityText: "Netsnek sponsors the Kärntner Linuxtag and helps bring the Linux days to Carinthia. You will find us at the Linux-Stammtisch on a regular basis.",
...
export const messagesSl: MessageCatalog = {
  ...
  OpenKnowledgeText: "V naši dokumentaciji objavljamo, kar smo se naučili, od poglavij o kvantnem računalništvu iz projekta PhotonQ do zapiskov o Linuxu in RPM ter varnostnih analiz. Naš repozitorij RPM ob tem ponuja popravljene pakete, ki so pri tem nastali.",
  OpenCommunityTitle: "Skupnost v regiji",
  OpenCommunityText: "Netsnek sponzorira Kärntner Linuxtag in pomaga, da linuxovi dnevi pridejo na Koroško. Redno se udeležujemo tudi srečanja Linux-Stammtisch.",
...
export const messagesIt: MessageCatalog = {
  ...
  OpenKnowledgeText: "Nella nostra documentazione pubblichiamo ciò che abbiamo imparato, dai capitoli sul calcolo quantistico nati con PhotonQ alle note su Linux e RPM fino alle analisi di sicurezza. Il nostro repository RPM mette a disposizione i pacchetti con le patch nati da quel lavoro.",
  OpenCommunityTitle: "Comunità sul territorio",
  OpenCommunityText: "Netsnek è sponsor del Kärntner Linuxtag e contribuisce a portare le giornate Linux in Carinzia. Al Linux-Stammtisch ci trovate regolarmente.",
...
export const messagesJa: MessageCatalog = {
  ...
  OpenKnowledgeText: "ドキュメントでは、PhotonQから生まれた量子コンピューティングの章からLinuxとRPMのメモ、セキュリティの記録まで、学んだことを公開しています。RPMリポジトリでは、その過程で生まれたパッチ適用済みパッケージを提供しています。",
  OpenCommunityTitle: "地域のコミュニティ",
  OpenCommunityText: "NetsnekはKärntner Linuxtagのスポンサーとして、Linuxの祭典をケルンテン州に根づかせる取り組みを支えています。Linux-Stammtischにも定期的に参加しています。",
