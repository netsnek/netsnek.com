...
import smtCalloutComponent from '../../components/features/main-content/callout/styles/callout';
import smtCodeSnippetComponent from '../../components/features/main-content/code-snippet/styles/codeSnippet';
import smtDrawerComponent from './components/drawer';
import smtFilesystemComponent from '../../components/features/main-content/filesystem/styles/filesystem';
import smtHeadingComponent from './components/heading';
import smtIconCardComponent from '../../components/features/main-content/icon-card/styles/iconCard';
import smtImageCardComponent from '../../components/features/main-content/image-card/styles/imageCard';
...
import smtcodeResultPreviewComponent from '../../components/features/main-content/code-result-preview/styles/codeResultPreview';
import smtUserProfilePage from '../../components/features/user/profile/styles/userProfile';
import smtUserActivityComponent from '../../components/features/user/activity/styles/userActivity';
import smtStepperComponent from './components/stepper';
import smtPostPreviewComponent from '../../components/features/post/preview/styles/postPreview';
import smtPostsPage from '../../components/features/post/styles/posts';
import smtInputComponent from './components/input';
import smtPostReaderView from '../../components/features/post/reader/styles/postReaderView';
import smtRatingFeature from './features/rating';
import smtToastComponent from '../../components/shared/components/toast/styles/toast';
import smtActionToolbarComponent from '../../components/shared/components/action-toolbar/styles/actionToolbar';
import smtTooltipComponent from './components/tooltip';
import smtPostEditorComponent from '../../components/features/post/editor/styles/postEditor';
...
import smtSinglePostPage from '../../components/features/post/styles/singlePost';
...
import smtUserAvatarComponent from '../../components/features/user/avatar/styles/userAvatar';
