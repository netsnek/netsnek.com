        ...
        >
          ...
          >
            ...
            <Button
              ...
              fontSize="sm"
              fontWeight="semibold"
              bg={'white'} // Conditionally setting the background color
              color={'black'} // Conditionally setting the text color
              _hover={{
                bg: 'brand.500' // Conditionally setting hover background color
              }}
              pos="relative"
              _before={{
                zIndex: '-1',
